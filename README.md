...
Repositório de provas antigas da Disciplina **Engenharia de Software** do curso de **Tecnologia em Sistemas de Computaćao** da **UFF** ministrado através do **CEDERJ**.
...
`git clone https://github.com/compcederj/engenharia-de-software.git`
...
`git clone git@github.com:compcederj/engenharia-de-software.git`
...
# Engenharia de Software
Repositório de provas antingas da Disciplina **Engenharia de Software** do curso de **Tecnologia em Sistemas de Computaçao** da **UFF** ministrado através do **CEDERJ**.
